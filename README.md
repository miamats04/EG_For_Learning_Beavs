...
* The networking portion of multiplayer implementation is a serious challenge.  If it turns out to be too much of a challenge, the rest of the team will need to correspondingly adjust to the change.    
...
*  We believe that external feedback would be most helpful around Week 8 assuming that we have a stable build.  As soon as a stable build is accessible, we will ask for feedback from play testers, who will be selected from group member’s friends.    
